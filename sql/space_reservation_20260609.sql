...
insert into sys_menu values(2011, '房间占用查看', '2010', 1, 'occupancy', 'space/reservation/occupancy', '', 'SpaceOccupancy', 1, 0, 'C', '0', '0', 'space:reservationItem:list', 'time', 'admin', sysdate(), '', null, '房间占用查看');
...
select 100, menu_id from sys_menu where menu_id between 2000 and 2055;

insert into sys_role_menu(role_id, menu_id) values
(101, 2010), (101, 2011), (101, 2012), (101, 2013), (101, 2014), (101, 2015),
(101, 2046), (101, 2048), (101, 2054), (101, 2055);

insert into sys_role_menu(role_id, menu_id) values
(102, 2010), (102, 2011), (102, 2015), (102, 2046);
