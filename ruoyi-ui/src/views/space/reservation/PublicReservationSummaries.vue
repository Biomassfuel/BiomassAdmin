<template>
  <div class="public-reservation-summaries">
    <el-form
      v-if="showSearch"
      :model="queryParams"
      ref="queryForm"
    ...
    <el-table v-loading="loading" :data="summaryList">
      ...
      <el-table-column label="房间" align="center" min-width="140" :show-overflow-tooltip="true">
      ...
      <el-table-column label="日期范围" prop="dateRangeText" align="center" min-width="170" />
      <el-table-column label="时间段" prop="timeRangeText" align="center" width="140" />
      ...
      <el-table-column label="场次数" prop="approvedItemCount" align="center" width="90" />
      <el-table-column label="预约备注" prop="detailRemark" align="center" min-width="140" :show-overflow-tooltip="true" />
...
<script>
import { listPublicReservationSummary } from '@/api/space/reservation'
import PublicDetailDialog from './PublicDetailDialog'
import { reservationTypeText, reservationTypeOptions, statusText } from './utils'

export default {
  name: 'PublicReservationSummaries',
