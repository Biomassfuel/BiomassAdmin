<template>
  <div class="statistics-page">
    ...
    <el-row :gutter="16">
      <el-col :xs="24" :lg="14">
        <el-card shadow="never" class="panel-card">
          ...
          <div ref="trendChart" class="chart" v-loading="loading" />
        </el-card>
      </el-col>
      <el-col :xs="24" :lg="10">
        <el-card shadow="never" class="panel-card">
          ...
          <div ref="statusChart" class="chart" v-loading="loading" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-card shadow="never" class="panel-card table-card">
      ...
      <el-table v-loading="loading" :data="roomRanking">
...
import { getStatisticsDashboard } from '@/api/space/statistics'
...
export default {
  ...
  methods: {
    ...
    getDashboard() {
      this.loading = true
      getStatisticsDashboard(this.queryParams).then(response => {
        const data = response.data || {}
        this.summary = data.summary || {}
        this.roomRanking = data.roomRanking || []
